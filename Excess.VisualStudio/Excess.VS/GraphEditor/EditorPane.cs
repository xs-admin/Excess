...
namespace Excess.VS
{
    ...
    public sealed class EditorPane : WindowPane, IOleComponent, IVsDeferredDocView, IVsLinkedUndoClient
    {
        ...
        private GraphDesigner _vsDesignerControl;
        ...
        protected override void Initialize()
        {
            ...
            _vsDesignerControl = new GraphDesigner(); //new VsDesignerControl(new ViewModel(_store, _model, this, _textBuffer));
        ...
        {
            pGuidCmdId = VSPackageGuids.DesignerEditorFactory;
