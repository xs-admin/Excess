...
..\..\.nuget\nuget push Excess.Extensions.NInjector.0.48.0-alpha.nupkg

del Excess.Extensions.NInjector.0.48.0-alpha.nupkg
...
..\..\.nuget\nuget push Excess.Extensions.0.48.0-alpha.nupkg

del Excess.Extensions.0.48.0-alpha.nupkg